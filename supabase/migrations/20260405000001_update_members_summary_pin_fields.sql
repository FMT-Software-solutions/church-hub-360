-- Update members_summary view to include pin authentication fields
-- This ensures the view contains all necessary data for the public member portal

-- Drop the view so we can recreate it with new columns
DROP VIEW IF EXISTS public.members_summary;

-- Recreate members_summary view
...
COMMENT ON VIEW public.members_summary IS 'Members summary view including branch info, address fields, tag data, tags_array, member_groups, and pin authentication fields';