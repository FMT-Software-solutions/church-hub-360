...
export const mockIncomeRecords: IncomeRecord[] = [
  {
    ...
    payment_method: 'cash',
    date: '2024-01-07',
    description: 'Regular Sunday offering collection',
    receipt_number: 'INC-2024-001',
    created_by: 'user-1',
  ...
  },
  {
    ...
    date: '2024-01-01',
    description: 'January tithe collection',
    receipt_number: 'INC-2024-002',
    created_by: 'user-1',
  ...
  },
  {
    ...
    date: '2024-01-14',
    description: 'Special offering for building renovation',
    receipt_number: 'INC-2024-003',
    created_by: 'user-1',
  ...
  },
  {
    ...
    payment_method: 'cash',
    date: '2024-01-21',
    description: 'Thanksgiving offering from harvest service',
    receipt_number: 'INC-2024-004',
    created_by: 'user-1',
...
// Mock Pledge Records
export const mockPledgeRecords: PledgeRecord[] = [
  {
    id: '1',
    organization_id: 'org-1',
    branch_id: 'branch-1',
    member_id: 'member-1',
    member_name: 'John Smith',
    pledge_amount: 6000.00,
    amount_paid: 2000.00,
    amount_remaining: 4000.00,
    pledge_type: 'building_fund',
    campaign_name: 'New Sanctuary Campaign',
    start_date: '2024-01-01',
    end_date: '2024-12-31',
    payment_frequency: 'monthly',
    status: 'active',
    description: 'Pledge for new sanctuary construction',
    created_by: 'user-1',
  ...
  },
  {
    ...
    payment_frequency: 'monthly',
    status: 'fulfilled',
    description: 'Annual missions pledge',
    created_by: 'user-1',
    created_at: '2024-01-01T10:00:00Z',
  ...
  },
  {
    ...
    member_id: 'member-3',
    member_name: 'David Wilson',
    pledge_amount: 3600.00,
    amount_paid: 900.00,
    amount_remaining: 2700.00,
    pledge_type: 'annual_pledge',
    start_date: '2024-01-01',
    end_date: '2024-12-31',
    payment_frequency: 'quarterly',
    status: 'active',
    description: 'Annual giving pledge',
    created_by: 'user-1',
    created_at: '2024-01-01T10:00:00Z',
  ...
  },
  {
    ...
    pledge_amount: 1200.00,
    amount_paid: 0.00,
    amount_remaining: 1200.00,
    pledge_type: 'special_project',
    campaign_name: 'Youth Ministry Equipment',
    start_date: '2024-02-01',
    end_date: '2024-06-30',
    payment_frequency: 'monthly',
    status: 'overdue',
    description: 'Pledge for youth ministry equipment',
    created_by: 'user-1',
...
export const mockPledgePayments: PledgePayment[] = [
  {
    ...
    payment_method: 'bank_transfer',
    notes: 'Monthly payment for building fund pledge',
    created_by: 'user-1',
  ...
  },
  {
    ...
    payment_method: 'cash',
    notes: 'Final payment for missions pledge',
    created_by: 'user-1',
  ...
  },
  {
    ...
    payment_method: 'check',
    notes: 'Quarterly payment for annual pledge',
    created_by: 'user-1',
...
export const mockBudgetCategories: BudgetCategory[] = [
  {
    ...
    name: 'Income',
    type: 'income',
    description: 'All church income sources',
    is_active: true,
  },
  {
    id: '2',
  ...
  },
  {
    ...
    type: 'income',
    parent_category_id: '1',
    description: 'Special collections and offerings',
    is_active: true,
  },
  {
    id: '4',
    name: 'Expenses',
    type: 'expense',
    description: 'All church expenses',
    is_active: true,
  },
  {
    id: '5',
  ...
  },
  {
    ...
    type: 'expense',
    parent_category_id: '4',
    description: 'Ministry-related expenses',
    is_active: true,
  },
];
