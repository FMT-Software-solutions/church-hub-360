...
export const mockAttendanceMembers: AttendanceMemberResult[] = [
  ...
  },
  {
    ...
    tags_array: ['Youth Ministry', 'Sunday School'],
    attendance_status: 'present',
    last_attendance: '2024-01-14',
  },
  {
  ...
  },
  {
    ...
    tags_array: ['New Member', 'Volunteer'],
